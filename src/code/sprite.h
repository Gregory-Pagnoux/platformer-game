...
// monster 
std::vector<sf::Texture> RunLeftSheet = loadCharacterSheet("../sprites/MonsterRunLeft");
std::vector<sf::Texture> RunRightSheet = loadCharacterSheet("../sprites/MonsterRunRight");
